...
# 2026-09-13: the preregistration said absent/none/gonelead show a note written DAYS ago. The old
# harness hard-coded 2 hours for every arm. Now set per arm, and the shown ls -la is recorded.
orchestrate.SEED_AGE.update({
    "FP.present":  "20 minutes ago",
    "FP.absent":   "3 days ago",
    "FP.none":     "3 days ago",
    "FP.gonelead": "3 days ago",
})
