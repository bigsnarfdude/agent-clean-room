...
# Vendored into agent-clean-room 2026-08-28, unmodified except for this shim. The original
# ran on numpy >= 2.0, where trapz was renamed trapezoid; without this it raises
# AttributeError on numpy 1.x and the whole domain is unrunnable for most people.
